...
namespace faketwitter.Controllers
{
    ...
    {
        private FollowerContext db = new FollowerContext();
        ...
        public ActionResult Create([Bind(Include = "FollowerId")] Follower follower)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FollowerId")] Follower follower)
        {
            if (ModelState.IsValid)
            {
